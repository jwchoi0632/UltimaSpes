...
public abstract class DropItem : MonoBehaviour, IInteractable, IPoolable<DropItem>
{
    ...
    public System.Action<DropItem> OnReturnToPool { get; set; }

    protected bool _isPickedup = false;

    public virtual void InitItem(int _id)
    {
    ...
    public virtual void OnInteraction(GameObject causer, InteractionType type, Vector2 force = default)
    {
