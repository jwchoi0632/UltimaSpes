...
public class CharacterStatsBase
{
    ...
    public MoveType moveType = MoveType.OnlyGround;
    ...
    [Header("Character Flying Stats")]
    public float moveMaxSpeed_flying = 5.0f;
    public float acceleration_flying_sec = 0.3f;
    public float deceleration_flying_sec = 0.5f;
